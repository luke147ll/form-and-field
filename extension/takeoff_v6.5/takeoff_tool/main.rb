module TakeoffTool
  ...
  load File.join(PLUGIN_DIR, 'dash_categories.rb')
  load File.join(PLUGIN_DIR, 'dash_edits.rb')
  load File.join(PLUGIN_DIR, 'dash_navigation.rb')
  load File.join(PLUGIN_DIR, 'dash_containers.rb')
  load File.join(PLUGIN_DIR, 'dash_actions.rb')
