module TakeoffTool
  module Parser
    ...
    CATEGORY_MEASUREMENTS = {
      ...
      'Outdoor Features'     => 'ea',
      # Cost code map categories
      'Footings and Foundation' => 'lf',
      'CMU Structure'        => 'sf',
      'Interior Concrete Slabs' => 'sf_cy',
      'Exterior Concrete/Slabs' => 'sf_cy',
      'Floor Framing/Trusses' => 'ea_bf',
      'Roof Trusses'         => 'ea',
      'Misc. Framing'        => 'ea_bf',
      'Timbers (Structural)' => 'ea_bf',
      'Masonry'              => 'sf',
      'Fireplace'            => 'ea',
      'Timbers (Decorative)' => 'ea_bf',
      'Windows & Exterior Glass Doors' => 'ea_sf',
      'Exterior Doors'       => 'ea',
      'Decking'              => 'sf',
      'Exterior Railing'     => 'lf',
      'Roofing Materials'    => 'sf',
      'Siding, Soffit, Fascia' => 'sf',
      'Gypcrete'             => 'sf',
      'Flooring Wood'        => 'sf',
      'Flooring Tile'        => 'sf',
      'Tile Walls'           => 'sf',
      'Wood Walls/Ceilings'  => 'sf',
      'Interior Doors'       => 'ea',
      'Interior Trim'        => 'lf',
      ...
      'Timber Beams'         => 'ea_bf',
      'Timber Posts'         => 'ea_bf',
      'Timber Rafters'       => 'ea_bf',
      'Timber Ridges'        => 'ea_bf',
      'Timber Purlins'       => 'ea_bf',
      'Timber Joists'        => 'ea_bf',
      'Timber Chords'        => 'ea_bf',
      'Timber Corbels'       => 'ea_bf',
      'Timber King Posts'    => 'ea_bf',
      'Timber Crowns'        => 'lf',
      'Timber Specialty'     => 'ea_bf',
      'Blocking'             => 'ea_bf',
      # IFC template — other categories
      'Hardware / Fasteners' => 'ea',
      'Concrete Walls'       => 'lf',
      'Piers'                => 'ea',
      'Slabs'                => 'sf_cy',
      'Footings'             => 'lf',
      'Engineered Lumber'    => 'ea_bf',
      'Metal Framing'        => 'lf',
      'Cement Board'         => 'sf',
      'Stone Veneer'         => 'sf',
      'Auxiliary'            => 'ea',
